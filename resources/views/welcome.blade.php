...
<html lang="es">
    ...
    <body class="bg-[#FDFDFC] text-[#1b1b18] flex flex-col items-center justify-center min-h-screen p-6 lg:p-8">
        ...
        <main class="w-full max-w-4xl flex flex-col lg:flex-row rounded-lg overflow-hidden shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)]">
            ...
            <div class="flex-1 p-8 lg:p-16 bg-white flex flex-col justify-between">
                ...
                <div>
                    ...
                    <h1 class="text-2xl font-semibold mb-2 text-[#1b1b18]">
                        Sistema de Gestión de Mantenimiento
                    </h1>
                    <p class="text-sm text-[#706f6c] mb-8 leading-relaxed">
                    ...
                    <ul class="flex flex-col gap-3 mb-8">
                        ...
                        <li class="flex items-start gap-3 py-2 border-b border-[#e3e3e0] last:border-0">
                            ...
                            <span class="text-sm text-[#1b1b18]">
                                ...
                                <span class="text-[#706f6c]"> — {{ $desc }}</span>
                            </span>
                        </li>
                        @endforeach
                    </ul>
                ...
                <div class="grid grid-cols-3 gap-3 mb-8">
                    ...
                    <div class="border border-[#e3e3e0] rounded-sm px-3 py-2 text-center">
                        <p class="text-sm font-semibold text-[#f53003]">{{ $kpi }}</p>
                        <p class="text-[10px] text-[#706f6c] mt-0.5 leading-tight">{{ $desc }}</p>
                    </div>
                    @endforeach
                </div>
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('activos.index') }}"
                       class="inline-block px-5 py-1.5 border border-[#19140035] hover:border-[#1915014a] text-[#1b1b18] text-sm rounded-sm leading-normal transition">
                        Ver activos
                    </a>
                </div>
            </div>
        ...
        <footer class="mt-8 text-xs text-[#706f6c]">
